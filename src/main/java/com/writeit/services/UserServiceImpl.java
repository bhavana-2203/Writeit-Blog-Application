...
public class UserServiceImpl implements UserService {
    ...
    public User createUser(User user) {
        if (userRepository.findUserByUsername(((String) user.getUsername()).toLowerCase()).isPresent())
            throw new CustomException("Username already taken : " + (((String) user.getUsername()).toLowerCase()),
                    HttpStatus.CONFLICT);
        user.setUsername(((String) user.getUsername()).toLowerCase());
    ...
    public User updateUserByUsername(User user, String username) {
        ...
        founduser.setUsername(user.getUsername() == null ? ((String) founduser.getUsername()).toLowerCase() : ((String) user.getUsername()).toLowerCase());
